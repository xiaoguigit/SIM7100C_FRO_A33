...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private void loadSystemSettings(SQLiteDatabase db) {
	    ...
	    loadIntegerSetting(stmt, Settings.System.MIRACAST_FULL_SCREEN,
		     R.integer.def_miracast_full_screen);

	    loadIntegerSetting(stmt, Settings.System.MIRACAST_CONTROL,
		     R.integer.def_miracast_control);
            ...
            // highlights
            loadStringSetting(stmt, Settings.System.SCREENRECORD_VIDEO_SIZE,
                    R.string.def_screenrecord_video_size);
            loadStringSetting(stmt, Settings.System.SCREENRECORD_VIDEO_TIME_LIMIT,
                    R.string.def_screenrecord_video_time_limit);
            loadStringSetting(stmt, Settings.System.SCREENRECORD_AUDIO_SOURCE,
                    R.string.def_screenrecord_audio_source);
    ...
    private void loadGlobalSettings(SQLiteDatabase db) {
        ...
        try {
            ...
            loadBooleanSetting(stmt, Settings.Global.ALWAYS_FINISH_ACTIVITIES,
                        R.bool.def_always_finish_activities);
